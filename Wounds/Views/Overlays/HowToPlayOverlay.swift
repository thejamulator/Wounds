                ...
                VStack {
                    ...
                    ScrollView {
                        VStack {
                            ...
                            Image("Star")
                            Text("When you tap a piece, its legal moves get hilighted.")
                                .multilineTextAlignment(.center)
                                .padding(.bottom, 10)
                                .padding([.leading, .trailing], 20)
                            Image("StarSelected")
                            ...
                            Text("Wounding")
                                ...
                                .fontWeight(.heavy)
                                .padding(.bottom, 10)
                            Text("When a piece moves onto the square occupied by an enemy, then enemy is captured UNLESS… it has an opposing prong facing directly into the attack.")
                                .multilineTextAlignment(.center)
                                .padding(.bottom, 10)
                                .padding([.leading, .trailing], 20)
                            Image("StarAndBishop")
                            ...
                            Text("Now the prong is short instead of long; the bishop can only move one square in that direction.")
                                .multilineTextAlignment(.center)
                                .padding(.bottom, 10)
                                .padding([.leading, .trailing], 20)
                            Text("Rotation")
                            ...
                            Text("Winning the Game")
                                ...
                                .fontWeight(.heavy)
                                .padding(.bottom, 10)
                            Text("There is currently only one game: Annihilation. As the name implies, you must capture every enemy piece to win.")
                                .multilineTextAlignment(.center)
                                .padding(.bottom, 10)
                                .padding([.leading, .trailing], 20)
                        }
